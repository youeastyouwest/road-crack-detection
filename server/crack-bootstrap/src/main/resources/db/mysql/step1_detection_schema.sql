CREATE TABLE IF NOT EXISTS detection_task (
    ...
    INDEX idx_detection_task_status_created_at (status, created_at),
    INDEX idx_detection_task_location_created_at (location, created_at)
);
...
CREATE TABLE IF NOT EXISTS detection_media (
    ...
    INDEX idx_detection_media_task_id (task_id)
);
...
CREATE TABLE IF NOT EXISTS detection_result_item (
    ...
    INDEX idx_detection_result_item_task_id (task_id),
    INDEX idx_detection_result_item_damage_severity (damage_type, severity_level)
);
